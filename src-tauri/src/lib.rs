...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_clean_spoken_corrections_setting,
            shortcut::change_clean_filler_removal_setting,
            shortcut::change_clean_numbers_setting,
            shortcut::change_clean_formatting_setting,
